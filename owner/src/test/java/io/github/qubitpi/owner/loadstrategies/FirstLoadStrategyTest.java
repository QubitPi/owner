...
import io.github.qubitpi.owner.PropertiesManagerForTest;
...
public class FirstLoadStrategyTest extends LoadStrategyTestBase {
    ...
    @Sources({"classpath:foo/bar/baz.properties",
            ...
            "classpath:io/github/qubitpi/owner/FooBar.properties",  // it will be loaded from here
    ...
    public void shouldLoadURLFromSpecifiedSource() throws IOException {
        ...
        manager.load();
        verify(loaders, times(1)).findLoader(argThat(uriMatches("io/github/qubitpi/owner/FooBar.properties")));
