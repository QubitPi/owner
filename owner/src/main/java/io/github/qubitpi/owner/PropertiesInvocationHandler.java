...
import static io.github.qubitpi.owner.Config.DisableableFeature.PARAMETER_FORMATTING;
import static io.github.qubitpi.owner.Config.DisableableFeature.VARIABLE_EXPANSION;
import static io.github.qubitpi.owner.PropertiesMapper.key;
import static io.github.qubitpi.owner.util.Util.isFeatureDisabled;
import static io.github.qubitpi.owner.util.Reflection.invokeDefaultMethod;
import static io.github.qubitpi.owner.util.Reflection.isDefault;
    ...
    private Object resolveProperty(Method method, Object... args) {
        ...
        if (value == null) {
            ...
            if (Collection.class.isAssignableFrom(method.getReturnType())) {
                return Converters.COLLECTION.tryConvert(method, method.getReturnType(), null);
            }
        ...
        Object result = Converters.convert(method, method.getReturnType(),
