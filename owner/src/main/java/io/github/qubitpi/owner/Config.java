...
import static io.github.qubitpi.owner.Config.HotReloadType.SYNC;
...
public interface Config extends Serializable {
    ...
    /**
     * Specifies the policy type to use to load the {@link Config.Sources} files for properties.
     *
     * @since 1.0.2
     */
    enum LoadType {
     ...
     *
     * <p>
     * To intercept the {@link ReloadEvent} see {@link Reloadable#addReloadListener(ReloadListener)}.
     *
     * @since 1.0.4
     */
    @Retention(RUNTIME)
