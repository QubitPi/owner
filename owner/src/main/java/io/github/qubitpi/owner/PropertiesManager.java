...
import io.github.qubitpi.owner.crypto.Decryptor;
import io.github.qubitpi.owner.crypto.IdentityDecryptor;
import io.github.qubitpi.owner.event.*;
...
import static io.github.qubitpi.owner.Config.LoadType.FIRST;
import static io.github.qubitpi.owner.PropertiesMapper.defaults;

import io.github.qubitpi.owner.event.ReloadEvent;
import io.github.qubitpi.owner.event.ReloadListener;
import io.github.qubitpi.owner.event.RollbackBatchException;
import io.github.qubitpi.owner.event.RollbackException;
import io.github.qubitpi.owner.event.RollbackOperationException;
import io.github.qubitpi.owner.event.TransactionalPropertyChangeListener;
import io.github.qubitpi.owner.event.TransactionalReloadListener;
...
class PropertiesManager implements Reloadable, Accessible, Mutable {
    ...
    public String setProperty(String key, String newValue) {
        ...
        try {
            ...
            try {
                if (Util.eq(oldValue, newValue)) return oldValue;
    ...
    private String performSetProperty(String key, Object value) {
        return (value == null) ?
                ...
                Util.asString(properties.setProperty(key, Util.asString(value)));
    }
    ...
    private String performRemoveProperty(String key) {
        return Util.asString(properties.remove(key));
    }
