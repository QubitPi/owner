...
import io.github.qubitpi.owner.Config.ConverterClass;
...
import static io.github.qubitpi.owner.Converters.SpecialValue.NULL;
import static io.github.qubitpi.owner.Converters.SpecialValue.SKIP;
import static io.github.qubitpi.owner.util.Util.expandUserHome;
import static io.github.qubitpi.owner.util.Util.unreachableButCompilerNeedsThis;
import static io.github.qubitpi.owner.util.Util.unsupported;
import static io.github.qubitpi.owner.util.Reflection.isClassAvailable;
...
enum Converters {
    ...
    PROPERTY_EDITOR {
        ...
        private final boolean isPropertyEditorDisabled =
                getBoolean("io.github.qubitpi.owner.property.editor.disabled");
